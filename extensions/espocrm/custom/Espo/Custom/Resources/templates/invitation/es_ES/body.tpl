                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; border: 1px solid #e8dfd5; overflow: hidden; box-shadow: 0 4px 12px rgba(28, 24, 20, 0.05);">
                    ...
                    <tr>
                        <td style="padding: 36px 32px;">
                                ...
                                <tr>
                                    <td style="padding: 20px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="padding: 6px 0; font-size: 14px; color: #6b5f52; width: 120px; font-weight: 600;">Servicio:</td>
                                            ...
                                            {{#if assignedUserName}}
                                            <tr>
                                                <td style="padding: 6px 0; font-size: 14px; color: #6b5f52; font-weight: 600;">Especialista:</td>
                                                <td style="padding: 6px 0; font-size: 14px; color: #1c1814;">{{assignedUserName}}</td>
                                            </tr>
                                            {{/if}}
                                            {{#if description}}
                                            <tr>
                                                <td style="padding: 6px 0; font-size: 14px; color: #6b5f52; font-weight: 600; vertical-align: top;">Notas:</td>
                            ...
                            <p style="margin: 16px 0; text-align: center;">
                                <a href="{{joinUrl}}" style="font-size: 14px; font-weight: 600; color: #c4a257; text-decoration: underline;">Acceder a la sesión online</a>
                            </p>
                            {{/if}}

                            {{#if isUser}}
                            <div style="margin-top: 24px; padding-top: 16px; border-top: 1px dashed #e8dfd5; text-align: center;">
                                <a href="{{recordUrl}}" style="font-size: 13px; color: #7a6e64; text-decoration: underline;">Ver registro en EspoCRM</a>
                            </div>
                            {{/if}}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: #faf7f2; padding: 24px 32px; border-top: 1px solid #e8dfd5; text-align: center; font-size: 12px; color: #7a6e64; line-height: 1.5;">
                            <p style="margin: 0 0 8px 0; font-weight: 600; color: #1c1814;">GAPSSA &bull; Centro de Salud y Bienestar</p>
                            ...
                            <p style="margin: 0; font-size: 11px; color: #9a8e84;">Si desea realizar alguna modificación o consulta sobre su cita, póngase en contacto con nosotros.</p>
                        </td>
                    </tr>
                </table>
            </td>
